...
- **`DEFENSE_IN_DEPTH.md`** — the working checklist this skill tracks progress in (format rules in
  `security-status-tracking`). The catalog and `Version:` live in this repo's
  [DEFENSE_IN_DEPTH.md](../../../DEFENSE_IN_DEPTH.md).
...
Copy [DEFENSE_IN_DEPTH.md](../../../DEFENSE_IN_DEPTH.md). That file is the catalog and the version
(`Version: x.y.z`). Target repos keep the same `Version:` line. Bump `Version` in this repo's file
