...
- `defense-in-depth-nodejs` writes a `Version: <semver>` line in the file header, matching
  [DEFENSE_IN_DEPTH.md](../../../DEFENSE_IN_DEPTH.md) in agentic. Missing means unversioned.
  Updating it is an audit change (rides along).
